   ...
   <form action="joinProcess.net" id = "addMember_form">
	 <fieldset>
		...
		<div class = "form-group">
			...
			<input type="text" id = "addMember_name" name = "name" placeholder="Enter name" maxLength="15">
		</div>
		<div class = "form-group">
			<label for = "addMember_age">나이</label>
			<input type="text" id = "addMember_age" name = "age" placeholder="Enter age" maxLength="2">
		</div>
		...
		<div class = "form-group">
			...
			<input type="email" id = "addMember_email" name = "email" placeholder="Enter email"  >
		</div>
